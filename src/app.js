...
initAuthGuard(({ user, profile, company }) => {
    ...
    const sectionMeta = {
        ...
        "goals": { title: "Goals & OKRs", subtitle: "Workspace corporate and team goals" },
        "reviews": { title: "Reviews", subtitle: "Performance appraisal cycles" },
        "feedback": { title: "Feedback", subtitle: "Continuous and peer feedback logs" },
